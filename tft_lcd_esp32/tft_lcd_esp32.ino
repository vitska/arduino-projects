...
// https://forum.arduino.cc/t/help-mcufriend-3-5-tft-lcd-480x320-esp32-solved/559854/5
// ESP board: ESP32 Dev Module
// Libraries: 
// MCUFRIEND_kbv: https://github.com/prenticedavid/MCUFRIEND_kbv
// Adafruit_GFX: https://github.com/adafruit/Adafruit-GFX-Library
// --------------------------- Replaced in UTFT_Demo_400x240 -----------------------
#define LCD_D0 12
#define LCD_D1 13
#define LCD_D2 26
#define LCD_D3 25
...
// int model_ID, int RS, int WR,int CS, int RST, int RD = A0
UTFTGLUE myGLCD(0,LCD_RS,LCD_WR,LCD_CS,LCD_RESET,LCD_RD); //all dummy args
// --------------------------- Replaced in UTFT_Demo_400x240 -----------------------
