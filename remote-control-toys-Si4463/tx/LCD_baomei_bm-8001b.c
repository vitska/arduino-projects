...
#define INIT_LCD_CS_PIN pinMode(9, OUTPUT)
#define INIT_MOSI_PIN pinMode(7, OUTPUT)
#define INIT_CLK_PIN pinMode(8, OUTPUT)

#define LCD_CS_0 digitalWrite(9, LOW)
#define LCD_CS_1 digitalWrite(9, HIGH)

#define MOSI_1 digitalWrite(7, HIGH)
#define MOSI_0 digitalWrite(7, LOW)

#define CLK_1 digitalWrite(8, HIGH)
#define CLK_0 digitalWrite(8, LOW)
